    ...
    <Layout>
      ...
      <section className="about">
        ...
        <div className="about-info">
          ...
          <img src="/image1.jpeg" alt="Stem cells" width="100%" />
          <p>
            ...
            liver, bones, brain, muscle etc.
          </p>
          <p>
            Cells are the building blocks of our bodies, they form tissues,
            organs and then the body systems. With over 50 trillion cells in our
            bodies, cellular health is crucial to our health
          </p>
          ...
          <p>
            ...
            cells. As one ages, the adult stem cells decrease in number and
            gradually become dysfunctional. If one is able to keep the
            regeneration of skin tissue at more youthful levels by the addition
            of adult stem cells, He/she would be able to maintain a
            youthful-looking skin for a longer period of time. Practical and
            experimental evidence exist to show that the repair of organs can be
            achieved with this technology. However, whether this same technology
            can be used to stop general aging is yet to be ascertained.
          </p>
          <p>
            Stem cells have the ability to replicate more cells, replace damaged
            cells and feed other cells
          </p>
          <img src="/image1.jpg" alt="Stem cells" width="100%" />
          <h2>The STC30</h2>
          <p>
          ...
          <p>
            ...
            World based in Malaysia. It is approved by several international
            bodies worldwide and approved in over 90 countries in all
            continents. It has five ingredients;
          </p>
          ...
          <p>
            In this modern world, it is nearly impossible to stay away from
            disease. From the foods we eat, the electronics we use and their
            radiations, ultra-violet rays from the sun, the drugs we use for
            medicine, the chemicals we use in farming, food preparation and also
            apply in different activities, the pollution, the stress, etc. And
            you find that everyone is a candidate of getting sick at anytime.
            The STC30 slows the ageing process, detoxifies and rejuvenate the
            body, promote cell regeneration, strengthen the immune system, give
            a new lease of life, a new strength, a new vigor and address several
            health conditions even those formerly known as incurable. It is good
            for everyone to optimize their health whether sick or not and it is
            recommended that everyone takes atleast two boxes of the STC30 in
            their life time for their own health. The STC30 is proven to cure
            100% with no side effects unlike the conventional medicines which
            most of the time remove symptoms and not the root cause but the
            STC30 treats from the root cause, the cellular level.{" "}
          </p>
          ...
          <p>
            ...
            completely. The time for healing ranges from one to six months.
          </p>
          ...
          <p>
            ...
            STC30 is 100% Natural 100% NO SIDE EFFECTS, NO OVERDOSE.
          </p>
          <p>
            ...
            sachet under tongue and allow it to dissolve. Do not swallow and
            drink lots of water
          </p>
          <p>
            The STC30 is 100% non toxic, all natural, 100% Halal, FDA
            registered, 100% no side effects, no overdose with $1,000,000
            product liability.
          </p>
